            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" v-model="dataResponden.pendidikan" aria-label="Default select example">
                      ...
                      <option value = "5">Perguruan Tinggi (D3,D4,S1,S2,S3)</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" v-model="dataResponden.pekerjaan" aria-label="Default select example">
